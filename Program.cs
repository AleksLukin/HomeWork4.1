...
namespace Homework_12
{
    ...
    public class BenchMark
    {
        ...
        {
            WordsRandom(words);
            WordsFind(wordsClass, words);
            ContainHashSet(Hashset, wordsClass);
        }
        public void WordsRandom(string[] words)
        {
        ...
        public void WordsFind(Words[] wordsClass, string[] words)
        {
        ...
        public void Test1()
        {
            FindInArray(words, "qwerty");
        }
        [Benchmark]
        public void Test2()
        {
            FindInHashSet(Hashset, new Words { Value = "qwerty" });
        }
    }
}
//| Method |         Mean |      Error |     StdDev |
//|------- |-------------:|-----------:|-----------:|
//|  Test1 | 36,321.86 ns | 675.605 ns | 631.961 ns |
//|  Test2 |     10.92 ns |   0.114 ns |   0.101 ns |
